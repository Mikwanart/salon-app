        ...
        <footer className="footer">
                ...
                <div className="footer-main">
                    <div className="container footer-grid">
                        <div className="footer-brand">
                            ...
                            <p>The leading destination for beauty services and salon management. Elevating your beauty experience one appointment at a time.</p>
                        ...
                        <div className="footer-col">
                            ...
                            <ul>
                                ...
                                <li><Link to="/about">Salon Software</Link></li>
            ...
            <div className="footer-bottom">
                <div className="container">
                    <p>© 2026 SalonBook Inc. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
