...
import { Calendar, History, User, LogOut, Clock, Star, Scissors, LayoutDashboard, Store, Users, BarChart2, ChevronRight } from 'lucide-react';
import './Profile.css';
...
export default function Profile() {
    const { user, logout, isSalonOwner, isAdmin } = useAuth();
    ...
    return (
        <div className="pd-layout">
            {/* Sidebar — hidden for admin / salon owner */}
            ...
            {/* Main Content */}
            <main className={`pd-main${isAdmin || isSalonOwner ? ' pd-main--full' : ''}`}>
                <div className="pd-content">
                    ...
                    {isAdmin && (
                        <>
                            <section className="pd-greeting-section">
                                <h1>Admin Panel</h1>
                                <p>Full control over the SalonBook platform.</p>
                            </section>

                            <section className="pd-role-shortcuts">
                                <div className="pd-section-header">
                                    <h2>Quick Actions</h2>
                                </div>
                                <div className="pd-shortcut-grid">
                                    <Link to="/admin" className="pd-shortcut-card">
                                        <div className="pd-shortcut-icon">
                                            <Store size={24} />
                                        </div>
                                        <div className="pd-shortcut-text">
                                            <span className="pd-shortcut-title">Manage Salons</span>
                                            <span className="pd-shortcut-desc">Approve, suspend or review all registered salons</span>
                                        </div>
                                        <ChevronRight size={18} className="pd-shortcut-arrow" />
                                    </Link>
                                    <Link to="/admin" className="pd-shortcut-card">
                                        <div className="pd-shortcut-icon">
                                            <Users size={24} />
                                        ...
                                        <div className="pd-shortcut-text">
                                            <span className="pd-shortcut-title">Manage Users</span>
                                            <span className="pd-shortcut-desc">View all users, assign roles and manage permissions</span>
                                        </div>
                                        <ChevronRight size={18} className="pd-shortcut-arrow" />
                                    </Link>
                                    <Link to="/admin" className="pd-shortcut-card">
                                        ...
                                        <div className="pd-shortcut-text">
                                            <span className="pd-shortcut-title">All Appointments</span>
                                            <span className="pd-shortcut-desc">Review and manage platform-wide bookings</span>
                                        </div>
                                        <ChevronRight size={18} className="pd-shortcut-arrow" />
                                    </Link>
                                    <Link to="/admin" className="pd-shortcut-card">
                                        ...
                                        <div className="pd-shortcut-text">
                                            <span className="pd-shortcut-title">Analytics</span>
                                            <span className="pd-shortcut-desc">Track revenue, bookings and platform activity</span>
                                        </div>
                                        <ChevronRight size={18} className="pd-shortcut-arrow" />
                                    </Link>
                                </div>
                            ...
                            <div className="pd-inline-signout">
                                <button className="pd-logout-btn" onClick={() => logout()}>
                                    <LogOut size={18} />
                                    <span>Sign Out</span>
                                </button>
                    ...
                    {isSalonOwner && !isAdmin && (
                        <>
                            <section className="pd-greeting-section">
                                <h1>Your Salon Hub</h1>
                                <p>A quick overview of your business. Head to your dashboard for full details.</p>
                            </section>
                            ...
                            <section className="pd-role-shortcuts">
                                ...
                                <div className="pd-shortcut-grid">
                                    <Link to="/dashboard" className="pd-shortcut-card">
                                        <div className="pd-shortcut-icon">
                                            <LayoutDashboard size={24} />
                                        </div>
                                        <div className="pd-shortcut-text">
                                            <span className="pd-shortcut-title">Full Dashboard</span>
                                            <span className="pd-shortcut-desc">Open your complete salon management panel</span>
                                        </div>
                                        <ChevronRight size={18} className="pd-shortcut-arrow" />
                                    </Link>
                                    <Link to="/dashboard" className="pd-shortcut-card">
                                        ...
                                        <div className="pd-shortcut-text">
                                            <span className="pd-shortcut-title">Appointments</span>
                                            <span className="pd-shortcut-desc">View and manage all upcoming client bookings</span>
                                        </div>
                                        <ChevronRight size={18} className="pd-shortcut-arrow" />
                                    </Link>
                                    <Link to="/dashboard" className="pd-shortcut-card">
                                        ...
                                        <div className="pd-shortcut-text">
                                            <span className="pd-shortcut-title">My Salon</span>
                                            <span className="pd-shortcut-desc">Update your salon profile, photos and details</span>
                                        </div>
                                        <ChevronRight size={18} className="pd-shortcut-arrow" />
                                    </Link>
                                    <Link to="/dashboard" className="pd-shortcut-card">
                                        ...
                                        <div className="pd-shortcut-text">
                                            <span className="pd-shortcut-title">Revenue & Analytics</span>
                                            <span className="pd-shortcut-desc">Track earnings, trends and top-performing services</span>
                                        </div>
                                        <ChevronRight size={18} className="pd-shortcut-arrow" />
                                    </Link>
                                </div>
